...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const themes = {
    ...
    dark: {
      ...
      vars: {
        ...
        '--btn-bg': '#1c3d39',
        '--btn-text': '#e0f5f2',
        '--btn-hover': 'rgba(86, 196, 184, 0.55)',
    ...
    ocean: {
      ...
      vars: {
        ...
        '--btn-bg': '#1a3347',
        '--btn-text': '#caf0f8',
        '--btn-hover': 'rgba(72, 191, 227, 0.55)',
    ...
    sunset: {
      ...
      vars: {
        ...
        '--btn-bg': '#3a1a28',
        '--btn-text': '#fce4d6',
        '--btn-hover': 'rgba(244, 132, 95, 0.55)',
  ...
  if (speedSlider && speedOut) {
    speedSlider.addEventListener('input', () => {
      speedOut.textContent = parseFloat(speedSlider.value).toFixed(1) + 'x';
    });
  }
